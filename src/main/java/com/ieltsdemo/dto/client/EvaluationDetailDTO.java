...
public class EvaluationDetailDTO {
    private String questionNum;          // Номер вопроса
    ...
    public EvaluationDetailDTO(String questionNum, String questionText, String userAnswer, boolean correct, String correctAnswer, String explanation) {
